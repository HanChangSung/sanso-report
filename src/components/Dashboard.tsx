...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-[100dvh] w-full flex-col-reverse overflow-hidden md:flex-row">
      ...
      <aside className="flex min-h-0 w-full flex-1 flex-col overflow-y-auto border-t border-gray-200 bg-white md:w-96 md:flex-none md:overflow-hidden md:border-t-0 md:border-r">
        ...
        <section className="flex flex-col md:min-h-0 md:flex-1">
          ...
          <ul className="overflow-y-auto px-3 pb-4 md:flex-1">
            {sites.length === 0 && (
